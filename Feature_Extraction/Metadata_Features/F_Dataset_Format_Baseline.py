...
def extract_dataset_format_features(meta: dict) -> dict:
    ...
    features["dataset_a_tokens"] = meta.get("sum_assistant_a_tokens", 0) or 0
    features["dataset_b_tokens"] = meta.get("sum_assistant_b_tokens", 0) or 0

    features["dataset_a_context_tokens"] = meta.get("context_a_tokens", 0) or 0
    features["dataset_b_context_tokens"] = meta.get("context_b_tokens", 0) or 0
